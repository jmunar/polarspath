...
use polars_structpath_types::indexmap::IndexMap;
...
pub fn derive_enum_path_impl(input: syn::DeriveInput) -> TokenStream {
    ...
    let variant_matches = variants.iter().enumerate().map(|(index, (converted_name, _))| {
        ...
        quote! { #type_name::#variant_ident => ::polars_structpath::polars_core::prelude::AnyValue::Enum(#index as u32, <#type_name as ::polars_structpath::EnumPath>::mapping()) }
    });
    ...
    quote! {
        impl ::polars_structpath::HasDataTypeWrapper for #type_name {
            fn data_type_wrapper() -> &'static ::polars_structpath::DataTypeWrapper {
                ...
                DATA_TYPE_WRAPPER.get_or_init(|| ::polars_structpath::DataTypeWrapper::new(::polars_structpath::DataTypeOpt::Enum(::polars_structpath::EnumOptInfo::from_iter([
                    #(#variants_map),*
                ]))))
            }
        }

        impl ::polars_structpath::EnumPath for #type_name {}

        impl ::polars_structpath::IntoAnyValueWith<#type_name> for ::polars_structpath::DataTypeWrapper
        where
            #type_name: ::polars_structpath::EnumPath,
        {
            type ChunkDataType = ::polars_structpath::polars_core::prelude::CategoricalType;

            fn to_any_value(&self, value: &#type_name) -> ::polars_structpath::polars_core::prelude::AnyValue {
                match &self.raw {
                    ::polars_structpath::DataTypeOpt::Enum(_) => match value {
                        #(#variant_matches),*
                    },
