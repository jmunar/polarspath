...
/// ```rust,ignore
/// polars_structpath_types::impl_enum_buffer!(EnumName, [
///     (Variant1, 1),
///     (Variant2, 2),
///     ...
/// ]);
...
pub fn derive_enum_path_impl(input: syn::DeriveInput) -> TokenStream {
    ...
    quote! {
        polars_structpath_types::impl_enum_buffer!(#enum_name, [#(#variant_data),*]);
    }
}
...
mod tests {
    ...
    fn test_derive_enum_path_ok() {
        ...
        assert_eq!(
            output_str,
            "polars_structpath_types :: impl_enum_buffer ! (TestEnum , [(Variant1 , 10) , (Variant2 , 20)]) ;"
        );
    }
}
