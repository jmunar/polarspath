...
///
/// ```rust
/// use polars_structpath_types::{DataTypeOpt, DataTypeWrapper, EnumOptInfo, data_type_wrapper};
...
macro_rules! data_type_wrapper {
    ...
    (UInt64) => { $crate::DataTypeWrapper::new($crate::DataTypeOpt::UInt64) };
...
mod tests {
    ...
    fn test_data_type_opt_macro_simple_types() {
        ...
        assert_eq!(
            data_type_wrapper!(UInt32),
            DataTypeWrapper::new(DataTypeOpt::UInt32)
        );
        assert_eq!(
            data_type_wrapper!(UInt64),
            DataTypeWrapper::new(DataTypeOpt::UInt64)
        );
        assert_eq!(
