...
use polars_structpath_types::{
    data_type_wrapper, field_type, HasDataTypeWrapper, Path, StructPath,
};
...
pub fn fields_polars() -> Vec<Field> {
    Vec::from([
        ...
        field_type!("req_vec_req_item_u64", List(UInt64)),
        ...
        field_type!("opt_vec_req_item_u64", List(UInt64)),
        ...
        field_type!("req_vec_opt_item_u64", List(UInt64)),
        ...
        field_type!("opt_vec_opt_item_u64", List(UInt64)),
