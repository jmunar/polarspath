use structpath::{
    Path, PathComponent, StructPath, StructPathError, StructPathTrait, StructValue, Value,
};
...
fn test_get_value_by_field_scalar() {
    let sample_struct = build_sample_struct();
    assert_eq!(
        sample_struct.get_value("f_string_scalar_required").unwrap(),
        Value::String("hello".to_string())
    );
    assert_eq!(
        sample_struct
            .get_value("f_integer_scalar_required")
            .unwrap(),
        Value::Integer(123)
    );
    assert_eq!(
        sample_struct.get_value("f_float_scalar_required").unwrap(),
        Value::Float(1.23)
    );
    assert_eq!(
        sample_struct
            .get_value("f_boolean_scalar_required")
            .unwrap(),
        Value::Boolean(true)
    );
    // assert_eq!(
    //     sample_struct.get_value("f_enum_scalar_required").unwrap(),
...
fn test_get_value_by_field_scalar_optional() {
    ...
    assert_eq!(
        sample_struct
            .get_value("f_string_scalar_optional")
            .unwrap()
            .into_inner()
            .unwrap(),
    ...
    assert_eq!(
        sample_struct
            .get_value("f_integer_scalar_optional")
            .unwrap()
            .into_inner()
            .unwrap(),
        Value::Integer(456)
    ...
    assert_eq!(
        sample_struct
            .get_value("f_float_scalar_optional")
            .unwrap()
            .into_inner()
            .unwrap(),
        Value::Float(4.56)
    ...
    assert_eq!(
        sample_struct
            .get_value("f_boolean_scalar_optional")
            .unwrap()
            .into_inner()
            .unwrap(),
        Value::Boolean(false)
    ...
    // assert_eq!(
    //     sample_struct.get_value("f_enum_scalar_optional").unwrap().into_inner().unwrap(),
    //     Value::Boxable(SampleEnum::B.clone_box())
    // );
    assert_eq!(
        sample_struct
            .get_value("f_struct_scalar_optional")
            .unwrap()
            .into_inner()
            .unwrap(),
        Value::Boxable(
...
fn test_get_value_by_field_scalar_optional_none() {
    ...
    assert_eq!(
        sample_struct.get_value("f_string_scalar_optional").unwrap(),
        Value::Optional(None)
    );
    assert_eq!(
        sample_struct
    ...
    assert_eq!(
        sample_struct.get_value("f_float_scalar_optional").unwrap(),
        Value::Optional(None)
    );
    assert_eq!(
        sample_struct
    ...
    // assert_eq!(
    //     sample_struct.get_value("f_enum_scalar_optional").unwrap(),
    //     Value::Optional(None)
    // );
    assert_eq!(
        sample_struct.get_value("f_struct_scalar_optional").unwrap(),
        Value::Optional(None)
    );
}
