...
To create a new project using `structpath_protobuf`, run the project generator script:
...
After creating your project, you can use structpath to access protobuf fields:
